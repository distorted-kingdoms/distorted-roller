<script>
  let eggs = [
	...
	{ "name": "Type Egg (Dark)", "type": "dark"},
	{ "name": "Type Egg (Dragon)", "type": "dragon"},
	{ "name": "Type Egg (Electric)", "type": "electric"},
	{ "name": "Type Egg (Fairy)", "type": "fairy"},
	{ "name": "Type Egg (Fighting)", "type": "fighting"},
	{ "name": "Type Egg (Fire)", "type": "fire"},
	{ "name": "Type Egg (Flying)", "type": "flying"},
	{ "name": "Type Egg (Ghost)", "type": "ghost"},
	{ "name": "Type Egg (Grass)", "type": "grass"},
	{ "name": "Type Egg (Ground)", "type": "ground"},
	{ "name": "Type Egg (Ice)", "type": "ice"},
	{ "name": "Type Egg (Normal)", "type": "normal"},
	{ "name": "Type Egg (Poison)", "type": "poison"},
	{ "name": "Type Egg (Psychic)", "type": "psychic"},
	{ "name": "Type Egg (Rock)", "type": "rock"},
	{ "name": "Type Egg (Steel)", "type": "steel"},
	{ "name": "Type Egg (Water)", "type": "water"},
  ];
...
pokemon.forEach(function (entry, index) {
	entry.types.forEach(function(type) {
		if(typeMapping[type]) {
			typeMapping[type].push(index);
		} else {
			typeMapping[type] = [index];
		}
	});	
...
<form on:submit|preventDefault={generateEggs}>
  <fieldset>
    ...
    <select id="egg-type" bind:value={type}>
      {#each eggs as egg}
